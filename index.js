  ...
  $.fn.extend({
    numericScale: function (options) {
      ...
      defaults = {
        responseRange: 5,
        topNumber: 9,
        lowOpinionAnswer: 'Never use this strategy',
        highOpinionAnswer: 'Almost always use this strategy'
      };
      ...
      return this.each(function () {
        ...
        $list.after('<input type="button" id="submitBtn" class="button btnStyle" ' 
          + 'value="Show my Teaching Profile" />');
        ...
        function tallyDiscipline(discipline) {
		  ...
		  //calculates the total value per discipline
          return total/4;
        }
...
//Gives the width of the bar graphs
          dWidth = 200 / dNumber;
        ...
        $("#submitBtn").click(function () {
          if (!window.localStorage) {
			...
			function myFunction() {
				var text = document.createTextNode("Print Report");
